...
import autoit	#for input with selenium
...
#Prepare the text for the post  
caption = day + '\'s Poem of the day:' + '\r\n' + hashtags

print("Using image: " + imagename)
print("Text:\n" + caption)

#Start mobile emulation to post image to IG
...
def cookies():
	cookie_btn = driver.find_element_by_xpath("//button[contains(text(),'Accept')]").click()
	sleep(2)
...
sleep(2)
autoit.control_send("Open","Edit1",imagename.replace(":", ":")) 
sleep(1.5)
